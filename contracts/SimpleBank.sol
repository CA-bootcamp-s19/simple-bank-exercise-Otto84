...
contract SimpleBank {
    ...
    mapping  (address => uint) private balances; //private for protect
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
        ...
        require(balances[msg.sender] >= withdrawAmount, "Insufficent account balance");
